...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["sliders"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["sliders"])('.main-slider-item', 'vertical');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["forms"])();
...
var accordion = function accordion(triggersSelector) {
  ...
  btns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      this.nextElementSibling.classList.toggle('active-content'); // следующий элемент соседа
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  window.addEventListener('resize', function () {
    // 'resize' -> изменение размера экрана
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (event) {
      ...
      input.files = event.dataTransfer.files; // event.dataTransfer.files -> файловая струкутура
...
var forms = function forms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      arr[0].length > 6 ? dots = '...' : dots = '.'; //split('.')[0] -> 'ewrer.jpg' => ['ewrer', 'jpg'], [0] - 1-я запись в массиве

      var name = arr[0].substring(0, 6) + dots + arr[1]; // substring(0, 6) - обрезает правую часть строки, останется 5 символов

      item.previousElementSibling.textContent = name; // previousElementSibling -> вместо <div>Файл не выбран</div> станет <div>name</div>
    });
  });
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      console.log(api); // closest() -> проверка если данный селектор в скобках, если да то будет true
...
var modals = function modals() {
  var btnPressed; // это означает let btnPressed = false (или undefined)
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      /*или ставим эту переменную scrollHeight */
      ) {
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); // при открытии модального окна подарок исчезает(третья функция) 
...
/*!***************************************!*\
  !*** ./src/js/modules/pictureSize.js ***!
  \***************************************/
/*! exports provided: pictureSize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pictureSize", function() { return pictureSize; });
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    ...
    img.src = img.src.slice(0, -4) + '-1.png'; // slice(0, -4) : something.png -> something (т.е. -4 обрезает 4 символы с конца)
  ...
  function hideImg(block) {
    ...
    img.src = img.src.slice(0, -6) + '.png'; // slice(0, -6) : something-1.png -> something (т.е. -6 обрезает 6 символы с конца)
  ...
  blocks.forEach(function (block) {
    block.addEventListener('mouseover', function () {
      // Наведение мыши на блок 
      showImg(block);
    });
    block.addEventListener('mouseout', function () {
      // выводим мышку из блока 
      hideImg(block);
    });
  });
};
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // btn.addEventListener('click', function() {      // через сервер JSON-SERVER
  ...
  btn.addEventListener('click', function () {
    // без сервера через путь к файлу
...
var sliders = function sliders(slides, dir, prev, next) {
  ...
  try {
    ...
    prevBtn.addEventListener('click', function () {
      plusSlides(-1);
      items[slideIndex - 1].classList.remove('sladeInLeft');
      items[slideIndex - 1].classList.add('sladeInRight');
    });
    nextBtn.addEventListener('click', function () {
      plusSlides(1);
      items[slideIndex - 1].classList.remove('sladeInRight');
      items[slideIndex - 1].classList.add('sladeInLeft');
    });
  } catch (e) {} // try и catch нужны для того чтобы не ломал верстку, так как у некоторых слайдеров отсутсувуют кнопки
  ...
  function activateAnimation() {
    if (dir === 'vertical') {
      paused = setInterval(function () {
        plusSlides(1);
        items[slideIndex - 1].classList.add('sladeInDown');
      }, 3000);
    } else {
      paused = setInterval(function () {
        plusSlides(1);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("\u041C\u044B \u043D\u0435 \u043C\u043E\u0436\u0435\u043C \u0437\u0430\u0444\u0435\u0447\u0438\u0442\u044C \u043E\u043F\u0440\u0435\u0434\u0435\u043B\u0451\u043D\u043D\u044B\u0439 \u0440\u0435\u0441\u0443\u0440\u0441 ".concat(url, ", status: ").concat(res.status));
